...
| M4 权限与管理 | 已实现 | FR-10、FR-12、FR-15、FR-19、FR-20 | 角色 CRUD、成员角色分配、频道权限覆盖、统一 CheckPermission、成员移除/禁言/恢复、消息撤回/管理员删除。权限守卫（死代码）、前端频道覆盖编辑 UI、测试覆盖待补充。 | M2/M3 资源模型。 | AC-04、AC-E5、AC-E7、AC-N4。 |
