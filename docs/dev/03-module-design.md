...
| M2 社交与私聊骨架 | 待实现 | FR-06、FR-07 | 好友申请处理、好友列表、一对一私聊会话创建和私聊入口。 | M1 用户与鉴权。 | AC-01、AC-E3。 |
| M2 社区与成员骨架 | 待实现 | FR-08、FR-09 | 社区创建、默认角色、默认频道、邀请加入和退出限制。 | M1 用户与审计。 | AC-02、AC-E4。 |
| M3 频道、消息和未读 | 待实现 | FR-11、FR-13、FR-14、FR-18 | 频道 CRUD、文本/私聊消息、游标分页、`ReadState`、通知基础记录。 | M2 社区、私聊和权限基础。 | AC-02、AC-05、AC-E6。 |
| M4 权限与管理 | 待实现 | FR-10、FR-12、FR-15、FR-19、FR-20 | 角色、成员角色、频道覆盖、统一权限计算、成员管理、消息撤回和删除。 | M2/M3 资源模型。 | AC-04、AC-E5、AC-E7、AC-N4。 |
| M5 实时与语音状态 | 待实现 | FR-05、FR-16、FR-17、FR-18 | `/realtime` 订阅权限、事件发布、在线状态、通知同步、语音状态会话。 | M3 消息/通知、M4 权限。 | AC-03、AC-05、AC-06、AC-N1、AC-N2。 |
