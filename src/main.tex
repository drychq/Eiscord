...
\newcommand{\Requirement}[9]{%
  \par\medskip
  \noindent{\bfseries #1\quad #2\hfill 优先级：#3}\par
  \vspace{0.25em}
  \noindent\begin{tabularx}{\linewidth}{L{2.6cm}Y}
    \toprule
    参与者 & #4 \\
    触发条件 & #5 \\
    前置条件 & #6 \\
...
\noindent\begin{tabularx}{\linewidth}{C{2.2cm}C{3cm}C{3cm}Y}
  ...
  V1.1 & \today & 待填写 & 补充 MVP 范围、优先级、开发追踪、逻辑接口、实时事件、数据约束、权限矩阵和验收映射。 \\
  \bottomrule
\end{tabularx}
